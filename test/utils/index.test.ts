...
test('getSurgeNodes', async t => {
  ...
  t.is(txt1[4], '测试 4 = vmess, 1.1.1.1, 8080, username=1386f85e-657b-4d6e-9d56-78badb75e1fd, ws=true, ws-path=/, ws-headers="host:1.1.1.1|user-agent:Mozilla/5.0 (iPhone; CPU iPhone OS 13_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/13.1.1 Mobile/15E148 Safari/604.1", tls=true');
...
test('getQuantumultNodes', t => {
  ...
  t.is(schemeList[0],  'vmess:');
  t.is(schemeList[1], 'vmess:');
  t.is(schemeList[2], 'vmess:');
